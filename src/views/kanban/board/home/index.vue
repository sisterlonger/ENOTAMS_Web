<template>
  <div class="container-work">
    <Breadcrumb v-show="false" :items="['menu.board', 'menu.work']" />
    <div class="work-image">
      <img src="@/assets/images/worker4.png" alt="403" class="user-image" />
    </div>
    <div class="content">
      <div class="left">
        <div class="card">
          <h3>{{ $t('work.index.notam') }}</h3>
          <div>
            <learnplan></learnplan>
          </div>
        </div>
