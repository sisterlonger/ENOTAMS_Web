        ...
        <tiny-col :span="8">
          <div class="col">
            <div class="left">
              ...
              <div class="left-title">{{ $t('work.index.collecting') }}</div>
            </div>
        ...
        <tiny-col :span="8">
          <div class="col">
            <div class="left">
              ...
              <div class="left-title">{{ $t('work.index.collected') }}</div>
            </div>
            <div class="divider"></div>
            <div class="right">
...
<script lang="ts" setup>
  ...
  import { getUserData, getUserChange } from '@/api/fetchInterface';
