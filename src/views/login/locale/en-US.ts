export default {
  ...
  'login.form.userCode.errMsg': 'Username cannot be empty',
  'login.form.userPwd.errMsg': 'Password cannot be empty',
  ...
  'login.form.userCode.placeholder': 'Username: admin',
  'login.form.userPwd.placeholder': 'Password: admin',
