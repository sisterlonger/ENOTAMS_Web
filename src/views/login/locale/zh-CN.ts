export default {
  ...
  'login.form.userCode.errMsg': '用户名不能为空',
  'login.form.userPwd.errMsg': '密码不能为空',
  ...
  'login.form.userCode.placeholder': '用户名：姓名首字母小写',
  'login.form.userPwd.placeholder': '密码：默认为a000000@',
