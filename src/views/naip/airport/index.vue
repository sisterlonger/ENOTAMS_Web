<template>
    <div class="container">
        <Breadcrumb v-show="false" :items="['menu.source', 'menu.airport']" />
        <div class="content">
...
import { queryAirPortTree, queryAirPortDetail } from '@/api/fetchInterface';
...
const getNodeDataSync = async () => {
    const { data } = await queryAirPortTree();
    return data;
}
