          ...
          <tiny-row>
            ...
            <tiny-col :span="3">
              <tiny-form-item label="气压基准面" prop="codeDistVerUpper">
                <tiny-input v-if='formData.class && formData.class.isContainVerLower' v-model="formData.class.codeDistVerUpper"></tiny-input>
              </tiny-form-item>
            </tiny-col>
            <tiny-col :span="3">
              <tiny-form-item label="高度上限(M)" prop="valDistVerUpper">
                <tiny-input v-if='formData.class && formData.class.isContainVerLower' v-model="formData.class.valDistVerUpper"></tiny-input>
              </tiny-form-item>
            </tiny-col>
            <tiny-col :span="3">
              <tiny-form-item label="是否包含高度上限" prop="isContainVerUpper">
                <tiny-input v-if='formData.class && formData.class.isContainVerLower' v-model="formData.class.isContainVerUpper"></tiny-input>
              </tiny-form-item>
            </tiny-col>
            <tiny-col :span="3">
              <tiny-form-item label="高度下限类型" prop="codeDistVerLower">
                <tiny-input v-if='formData.class && formData.class.isContainVerLower' v-model="formData.class.codeDistVerLower"></tiny-input>
              </tiny-form-item>
            </tiny-col>
            <tiny-col :span="3">
              <tiny-form-item label="高度下限(M)" prop="valDistVerLower">
                <tiny-input v-if='formData.class && formData.class.isContainVerLower' v-model="formData.class.valDistVerLower"></tiny-input>
              </tiny-form-item>
            </tiny-col>
            <tiny-col :span="3">
              <tiny-form-item label="是否包含高度下限" prop="isContainVerLower">
                <tiny-input v-if='formData.class && formData.class.isContainVerLower' v-model="formData.class.isContainVerLower"></tiny-input>
              </tiny-form-item>
            </tiny-col>
          </tiny-row>
          <tiny-row class="title">频率信息</tiny-row>
          <tiny-grid
            ref="theGridRef"
            :data="formData.radios"
            seq-serial
            :stripe="true"
          >
